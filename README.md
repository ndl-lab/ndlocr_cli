...
事業の詳細については、[令和3年度OCR処理プログラム研究開発](https://lab.ndl.go.jp/data_set/ocr/r3_software/)をご覧ください。
...
**本プログラムに対して追加開発を行った令和4年度NDLOCR追加開発事業の成果物である[NDLOCR ver.2.0](https://github.com/ndl-lab/ndlocr_cli_r4/tree/ver.2.0)**

及び

**ver.2.0をもとに国立国会図書館が更に改善を行った[NDLOCR ver.2.1](https://github.com/ndl-lab/ndlocr_cli_r4)についても提供しています。**
...
```
git clone -b ver.1 --recursive https://github.com/ndl-lab/ndlocr_cli
```
